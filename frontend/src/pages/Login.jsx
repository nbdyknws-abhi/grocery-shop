    ...
    <div className="auth-page enhanced-bg">
      ...
      >
        <div className="text-center mb-4">
          ...
          >
            Welcome Back to Your Grocery World!
          </motion.h2>
          <motion.p
        ...
        <div className="blog-cards mb-4">
          <div className="blog-card">
            <h6>💡 Smart Tip</h6>
            <p>Get weekly deals directly to your inbox by staying logged in.</p>
          </div>
          <div className="blog-card">
            <h6>🍎 Fresh Pick</h6>
            <p>Login to unlock today’s exclusive fruits & veggies offers.</p>
          </div>
        </div>
